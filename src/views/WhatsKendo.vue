<template>
  <div class="whats-kendo">
          <h1>General Definition</h1>
      ...
      <h1>All Japan Kendo Federation defintion of Kendo</h1>
      <div>
          <h2>The Concept of Kendo</h2>

          The concept of Kendo is to discipline the human character through the application of the principles of the Katana (sword).

          <h2>The Purpose of Practicing Kendo</h2>
          ...
          <h2>“The Mindset of Kendo Instruction” and its explanation</h2>

          <h3>The Significance of the Shinai</h3>
